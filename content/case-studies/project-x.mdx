...
> **An update, July 2026.** Since I wrote the section below, the waiting ended. Every flow the product needs is designed: the first run, an ordinary study day, how it works out what a student actually knows, and the moment it asks for money. The mechanics and the pricing are settled, and there is a launch date again, this one set from readiness rather than hope. I'm not printing the date on this page until it's announced properly, which is the same discipline the rest of this story is about: I don't get to announce a thing twice.
