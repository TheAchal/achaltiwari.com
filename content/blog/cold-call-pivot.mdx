...
Project X needed beta users. The clock was running, back then we still thought the launch date was fixed. Before you can launch, you need real students using the product and giving feedback.
...
2. **In-app prompts in InfiNotes.** The thousands of users already in the ecosystem see a subtle prompt: "We're building something new. Want early access?"
